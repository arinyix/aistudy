...
if ($_POST) {
    try {
        ...
        // Log para debugging
        error_log("Iniciando geração de quiz para rotina: " . $routine_id);
        
        // Tentar gerar quiz com IA
        try {
            $openai = new OpenAIService();
            $quiz_data = $openai->generateQuiz($rotina['tema'], $rotina['nivel'], $rotina['titulo']);
            ...
            $quiz_json = FallbackData::getQuiz($rotina['tema'], $rotina['nivel']);
        }
        ...
        if ($quiz_json && isset($quiz_json['perguntas'])) {
            ...
            $quiz->titulo = "Quiz: " . $rotina['titulo'];
...
<head>
    ...
    <title>AIStudy - Gerar Quiz</title>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">
                            <i class="fas fa-question-circle me-2"></i>Gerar Quiz
                        </h5>
                    </div>
                    <div class="card-body">
                        <?php echo $message; ?>
                        ...
                        <div class="text-center mb-4">
                            <i class="fas fa-brain text-primary fa-4x mb-3"></i>
                            <h4>Gerar Quiz Inteligente</h4>
                            <p class="text-muted">
                                Nossa IA irá criar um quiz personalizado sobre 
                        ...
                        <div class="alert alert-info">
                            ...
                            <strong>Como funciona:</strong> A IA analisará o conteúdo da sua rotina e criará 5 perguntas 
                            desafiadoras e apropriadas para o nível <strong><?php echo ucfirst($rotina['nivel']); ?></strong>.
                        </div>
                        ...
                        <form method="POST">
                            <div class="d-flex justify-content-between">
                                ...
                                <button type="submit" class="btn btn-primary" id="generateBtn">
                                    <i class="fas fa-magic me-2"></i>Gerar Quiz
                                </button>
                            </div>
                        </form>
                    </div>
